...
namespace WebApp.Migrations
{
    ...
    [Migration("20190803090030_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApp.Models.Brands", b =>
                {
            ...
            modelBuilder.Entity("WebApp.Models.DeliveredBrands", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(20);
            ...
            modelBuilder.Entity("WebApp.Models.ProducedBrands", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(20);
            ...
            modelBuilder.Entity("WebApp.Models.Terminal", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(10);
            ...
            modelBuilder.Entity("WebApp.Models.TerminalsAndBrands", b =>
                {
            ...
            modelBuilder.Entity("WebApp.Models.DeliveredBrands", b =>
                {
                    b.HasOne("WebApp.Models.ProducedBrands", "ProduceBrands")
            ...
            modelBuilder.Entity("WebApp.Models.ProducedBrands", b =>
                {
                    b.HasOne("WebApp.Models.Brands", "Brand")
